...
def run():
    try:
        ...
        ip = input('Please enter your LAN IP(v4) address (XXX.XXX.XXX.XXX): ')
        port = int(input('Please select the port you will listen on (eg, 8081): '))

        # dylan's is '192.168.0.21' and 8081
        server_address = (ip, port) #('127.0.0.1', 8081)
